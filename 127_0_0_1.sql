...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-06-2022 a las 21:26:15
...
--
CREATE DATABASE IF NOT EXISTS `baselogin` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `baselogin`;
...
('root', '[{\"db\":\"baselogin\",\"table\":\"productos\"},{\"db\":\"baselogin\",\"table\":\"usuarios\"},{\"db\":\"baselogin\",\"table\":\"usuario\"},{\"db\":\"base_login\",\"table\":\"usuarios\"}]');
...
('root', '2022-06-18 15:52:49', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
