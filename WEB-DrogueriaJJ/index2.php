...
<br><div id="contenido">
 <center><a href="nuevo_prod1.php"> <button type="button" class="btn btn-inf">Nuevo</button></a></center><br>
...
{
    echo "<tr>";
    echo "<td>"; echo $fila['id_productos']; echo "</td>";
    echo "<td>"; echo $fila['nombre']; echo "</td>";
    echo "<td>"; echo $fila['descripcion']; echo "</td>";
    echo "<td>"; echo $fila['fecha']; echo "</td>";
    echo "<td>"; echo $fila['imagen']; echo "</td>";
    echo " <td><a href='modif_prod1.php?no=".$fila['id_productos']."'> <button type='button'class='btn btn-success'>Modificar</button></a></td>";
    echo " <td><a href='eliminar_prod.php?no=".$fila['id_productos']."'> <button type='button'class='btn btn-danger'>Eliminar</button></a></td>";
    echo "</tr>";
}
?>
