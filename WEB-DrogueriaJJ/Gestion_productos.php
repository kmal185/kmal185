...
<header id="header" class="hoc clear">
  ...
  <section id="services">
    ...
    <label><br>Codigo de Producto:<input type="number" id="id_producto" name="id_producto" required><br><br>
    ...
    <br>
    <label>Imagen producto<input type="file" id="imagen" name="imagen" required><br></label>
    <br>
